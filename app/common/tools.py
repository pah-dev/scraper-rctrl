...
def run_chrome():
    ...
    if(current_app.config["USE_BIN"]):
        chrome_options.binary_location = current_app.config["GOOGLE_CHROME_BIN"]
    ...
    return webdriver.Chrome(
        executable_path=current_app.config["CHROMEDRIVER_PATH"], options=chrome_options)
